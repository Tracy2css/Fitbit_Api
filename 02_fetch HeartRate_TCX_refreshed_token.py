...
log_id = '65165103777'  # Replace with the actual activity log ID

# Paths to save the JSON and CSV files
output_json_path = r'L:\PhD_Prototype\ResearchDesign01_Physio Prototype\ECG Measurement\Test_Fitbit\Fitbit_Api\HeartBeat_Test_TCX_0807meeting.json'  # Replace with your actual JSON output path
output_csv_path = r'L:\PhD_Prototype\ResearchDesign01_Physio Prototype\ECG Measurement\Test_Fitbit\Fitbit_Api\HeartBeat_Test_TCX_08070meeting.csv'  # Replace with your actual CSV output path
